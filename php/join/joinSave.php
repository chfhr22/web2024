...
<body class="gray">
    ...
    <main id="main" role="main">
        <div class="intro__inner container">
            ...
            <img srcset="../asset/img/intro01@1x.jpg 1x, ../asset/img/intro01@2x.jpg 2x, ../asset/img/intro01@3x.jpg 3x" alt="인트로 이미지">
            </div>
            <div class="intro__text">
                <?php
                    ...
                    if($isEmailCheck = true && $isPhoneCheck = true){
                        ...
                        if($result){
                            msg("회원가입을 축하합니다.! 로그인을 해주세요. <div class='intro__btn'><a href='../main/main.php'>메인으로</a><a href='../login/login.php'>로그인</a></div>");
                            exit;
                        } else {
                        ...
                        msg("이미 회원가입이 되어있습니다. 다시 한번 확인해주세요! <div class='intro__btn'><a href='../main/main.php'>메인으로</a><a href='../login/login.php'>로그인</a></div>");
                        exit;
                    }
                ?>
            </div>
